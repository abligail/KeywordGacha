...
class LocalizerZH():
    ...
    expert_settings_page_multi_agent_gender_vote_min_count_title: str = "性别投票触发阈值"
    expert_settings_page_multi_agent_gender_vote_min_count_description: str = "人名出现次数达到该阈值时启用多窗口投票"
    expert_settings_page_multi_agent_gender_vote_max_windows_title: str = "性别投票最大窗口数"
    expert_settings_page_multi_agent_gender_vote_max_windows_description: str = "多窗口投票的最大窗口数量"
