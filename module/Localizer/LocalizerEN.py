...
class LocalizerEN(LocalizerZH):
    ...
    expert_settings_page_multi_agent_gender_vote_min_count_title: str = "Gender Vote Trigger Count"
    expert_settings_page_multi_agent_gender_vote_min_count_description: str = "Enable multi-window voting when count meets this threshold"
    expert_settings_page_multi_agent_gender_vote_max_windows_title: str = "Max Gender Vote Windows"
    expert_settings_page_multi_agent_gender_vote_max_windows_description: str = "Maximum number of windows for gender voting"
